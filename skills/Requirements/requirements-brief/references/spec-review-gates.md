...
- 阶段：draft | init | update | plan
- 评审周期：<material change set>
- 当前轮次：<n>（目标 2-3；硬上限 10）
- 参与 Skills / 角色：<最小组合>
- 综合结论：Approved | Issues Found | Needs Clarification

| 设计问题 | 来源/经验 | 提取的优秀机制 | 适用边界与取舍 | 方案落点 |
| --- | --- | --- | --- | --- |
| ... | ... | ... | ... | ... |

| 专家意见 | 来源 | 处置 | 方案落点 / 取舍理由 |
| --- | --- | --- | --- |
| BUILD-001 ... | ... | adopted | ... |

| 维度 | 适用性 | 结论 | 关键证据 / 修正 |
| --- | --- | --- | --- |
| 产品价值与功能边界 | required | pass | ... |
...
- <本次采用的术 -> 可能的跨场景机制 -> 适用边界与证据；0-3 条或 None>
```

只保留能解释方案为何可定稿的短记录；完整证据放正文、明确来源或 Git 历史，不复制成第二份评审报告。
