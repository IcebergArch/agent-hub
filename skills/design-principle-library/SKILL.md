...
description: 当完成或复盘架构设计、coding 分层设计、系统设计、UI/交互设计、数据体系设计、工具协议设计等高风险设计后，用于抽取可复用原则、反模式、检查清单和实践积累，减少后续依赖用户手动 rule update。
---
...
- 用户明确说 `rule update`、要求复盘设计质量、指出“为什么没想到”“应该自我提升”。
