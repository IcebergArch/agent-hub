...
日期：2026-06-11
来源：吸收外部 skill 工具映射、agent manifest、可视化 helper、系统调试压力测试与 creation log 后整理。
...
| Persistent memory | 当前 Hub 允许把什么写进 README、AGENTS、Skill 或文档工作区？ | 按 Hub 信息分类写入；不写私密、一时过程或平台缓存 |
